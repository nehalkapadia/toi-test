...
module.exports = (app) => {
  ...
  app.use(`${baseRoute}/orderTypes`, require('./order_types.route'));
  app.use(`${baseRoute}/orderDetails`, require('./order_details.route'));
  app.use(`${baseRoute}/cptCode`, require('./cpt_codes.route'));
};
